...
// +build ignore
//
// This build tag means that "go install github.com/mantyr/image/..." doesn't
...
package main // import "github.com/mantyr/image/cmd/webp-manual-test"
